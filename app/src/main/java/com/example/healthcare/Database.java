...
public class Database extends SQLiteOpenHelper {
    ...
    public void addOrder(String username,String fullname,String address,String contact,int pincode,String date,String time,float price,String otype){
        ...
        cv3.put("username",username);
        cv3.put("fullname",fullname);
        cv3.put("address",address);
        cv3.put("contactno",contact);
        cv3.put("pincode",pincode);
        cv3.put("date",date);
        cv3.put("time",time);
        cv3.put("amount",price);
        cv3.put("otype",otype);
        SQLiteDatabase db=getWritableDatabase();
        db.insert("orderplace",null,cv3);
        db.close();
    }
