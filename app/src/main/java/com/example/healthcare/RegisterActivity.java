...
public class RegisterActivity extends AppCompatActivity {
    EditText edUsername, edPassword, edMail, edConfirm;
    Button btn;
    TextView tv;
    @Override
                ...
                if (username.length() == 0 || email.length() == 0 || password.length() == 0) {
                    ...
                    if (password.compareTo(confirm) == 0) {
                        if (isValid(password)) {
                            ...
                            Toast.makeText(getApplicationContext(), "Password must contain at least 8 characyors, having leter, digit and special symnol", Toast.LENGTH_SHORT).show();
                        }
                    } else {
